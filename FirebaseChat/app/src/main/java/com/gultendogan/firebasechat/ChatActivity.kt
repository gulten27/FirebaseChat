...
import com.gultendogan.firebasechat.adapter.MessagesAdapter
import com.gultendogan.firebasechat.databinding.ActivityChatBinding
...
class ChatActivity : AppCompatActivity() {
    ...
    var messages : ArrayList<com.gultendogan.firebasechat.model.Message>? = null
            ...
            .addValueEventListener(object : ValueEventListener {
                ...
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    for (snapshot1 in snapshot.children){
                        val message : Message? =
                            snapshot1.getValue(Message::class.java)
